...
func TestCreateEvent(t *testing.T) {
	...
	req, err := http.NewRequest("POST", "/create-event", bytes.NewBuffer(reqBody))
	if err != nil {
...
// 	// Check the response body
// 	expected := `{"message":"Created!","event":{"name":"Test Event","description":"This is a test event","start":"` + start + `","end":"` + end + `","location":"Test Location","organizer_id":1,"created_at":"0001-01-01T00:00:00Z","updated_at":"0001-01-01T00:00:00Z","event_limit":100}}`
